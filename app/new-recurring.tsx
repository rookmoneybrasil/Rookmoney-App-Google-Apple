      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.typeRow}>
          {TYPES.map((t) => (
            <TouchableOpacity
              key={t.value}
              style={[styles.typeBtn, type === t.value && { borderColor: t.color, backgroundColor: t.color + '18' }]}
              onPress={() => setType(t.value)}
            >
              <Text style={[styles.typeLabel, type === t.value && { color: t.color }]}>{t.label}</Text>
            </TouchableOpacity>
          ))}
        </View>
        ...
        <TextInput
          style={styles.input}
          placeholder="Ex: Spotify, Academica..."
